...
![JvmSpec7](/minsssg/tistory-example-code/java/images/weekly1/JvmSpec7.png)
...
![자바컴파일](/minsssg/tistory-example-code/java/images/weekly1/java-compile.PNG)
...
![자바역컴파일](/minsssg/tistory-example-code/java/images/weekly1/java-decompile.PNG)
...
![자바실행](/minsssg/tistory-example-code/java/images/weekly1/java-run.PNG)
...
![jit컴파일러](/minsssg/tistory-example-code/java/images/weekly1/jit-compiler.png)

출처: https://bloofer.tistory.com/21

# JVM 구성 요소😵

![JVM구성요소](/minsssg/tistory-example-code/java/images/weekly1/JVM-configuration.png)
